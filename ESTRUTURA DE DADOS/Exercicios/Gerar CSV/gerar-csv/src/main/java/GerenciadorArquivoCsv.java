...
//Recupere um elemento da lista e formate aqui:
    ...
    public static void leArquivoCsv1(String nomeArq) {
        String[] header = {"ID", "NOME", "PORTE", "PESO"};
        String csvFilePath = "dadosPet.csv";
        ...
        try (
            ...
            csvPrinter.printRecord(1, " Chubaca", " Grande", 12.0);
            csvPrinter.printRecord(2, " Flor", " Pequeno", 8.0);
            csvPrinter.printRecord(3, " Sabrina", " Médio", 20.0);
            csvPrinter.printRecord(4, " Lulu", " Pequeno", 5.0);
